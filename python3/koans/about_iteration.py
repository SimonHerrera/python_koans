...
class AboutIteration(Koan):
    ...
    def test_iterators_are_a_type(self):
        it = iter(range(1,6)) # (1, 2, 3, 4, 5)

        fib = 0

        for num in it: # (1, 2, 3, 4, 5)
            fib += num # 0 + 1 = 1 + 2 = 3 + 3 = 6 + 4 = 10 + 5 = 15

        self.assertEqual(15 , fib)

    def test_iterating_with_next(self): # https://docs.python.org/3/glossary.html#term-iterator
    ...
    def test_just_return_first_item_found(self):
        ...
        self.assertEqual('Clarence', name) # first name > 4 chars
    ...
    def test_reduce_will_blow_your_mind(self):
        ...
        # - Stacks them on top of itself - maybe
    # ------------------------------------------------------------------
