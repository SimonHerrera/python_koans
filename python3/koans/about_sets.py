...
class AboutSets(Koan):
    ...
    def test_set_have_arithmetic_operators(self):
        ...
        self.assertEqual({'Willie'}, scotsmen - warriors) # remove commons and don't include warriors
        self.assertEqual({'MacLeod', 'Wallace', 'Willie', 'Leonidas'}, scotsmen | warriors) # combined w no repeats
        self.assertEqual({'Wallace', 'MacLeod'}, scotsmen & warriors) # common to
        self.assertEqual({'Willie', 'Leonidas'}, scotsmen ^ warriors) # no commons but all others
    ...
    def test_we_can_compare_subsets(self):
        ...
        self.assertEqual(True, set('cake').issubset(set('cherry cake')) ) # every element in first is in second

        self.assertEqual(False, set('cake') > set('pie')) # Test whether the set is a proper superset of other, that is, set >= other and set != other
